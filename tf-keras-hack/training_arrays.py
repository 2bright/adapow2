...
def fit_loop(model,
  ...
  if hasattr(model.optimizer, 'on_epoch_begin'):
    ...
    optimizer_on_epoch_begin = lambda *args: None

  if hasattr(model.optimizer, 'on_epoch_end'):
    optimizer_on_epoch_end = model.optimizer.on_epoch_end
  else:
    optimizer_on_epoch_end = lambda *args: None
  ...
  for epoch in range(initial_epoch, epochs):
    ...
    if steps_per_epoch is not None:
      ...
      for batch_index, (batch_start, batch_end) in enumerate(batches):
        ...
        batch_logs.pop('train_function', None)
        batch_logs.pop('inputs', None)
